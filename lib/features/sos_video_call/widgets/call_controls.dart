...
class _TactileControlButtonState extends State<_TactileControlButton>
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor = widget.isDangerous
        ? Colors.white
        : widget.isEnabled
        ? Colors.white
        : const Color(0xFFF87171);
    final border = widget.isDangerous
        ? null
        : Border.all(
        ...
        child: ScaleTransition(
          ...
          child: Container(
            ...
            child: IconButton(
              ...
              icon: Icon(widget.icon, color: iconColor, size: 24),
